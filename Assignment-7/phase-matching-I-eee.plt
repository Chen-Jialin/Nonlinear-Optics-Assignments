...
set output 'phase-matching-I-eee.tex'
plot 1 / sqrt((cos(x) / n_O(omega_p))**2 + (sin(x) / n_E(omega_p))**2) * omega_p - 1 / sqrt((cos(x) / n_O(omega_s))**2 + (sin(x) / n_E(omega_s))**2) * omega_s - 1 / sqrt((cos(x) / n_O(omega_i))**2 + (sin(x) / n_E(omega_i))**2) * omega_i
set output